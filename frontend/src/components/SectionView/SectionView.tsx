...
function drawTopView(
  ...
  for (const p of placed) {
    ...
    ctx.strokeStyle = crossesCut ? hexToRgba(color, 0.3) : isHL ? '#fff' : hexToRgba(color, 0.8)
...
export default function SectionView({
  ...
  containerL = 5898, containerW = 2352, containerH = 2393,
}: Props) {
  ...
  useEffect(() => {
    ...
    drawTopView(tCtx, placed, highlightedItem, layerHeight, tw, th, containerL, containerW, containerH)
    drawSideView(sCtx, placed, highlightedItem, layerHeight, sw, sh, containerL, containerH)
  }, [placed, layerHeight, highlightedItem, containerL, containerW, containerH])
